...
char *httpdRequestMethodName(httpReq *request)
{
...
httpVar *httpdGetVariableByName(httpd    *server, httpReq    *request, char    *name)
{
	httpVar	*curVar;
...
httpVar *httpdGetVariableByPrefix(httpd *server, httpReq *request, char *prefix)
{
	httpVar	*curVar;
...
httpVar *httpdGetVariableByPrefixedName(httpd *server, httpReq *request, char *prefix, char *name)
{
	httpVar	*curVar;
	int	prefixLen;
...
int httpdSetVariableValue(httpd *server, httpReq *request, char *name, char *value)
{
	httpVar *var;
...
httpd *httpdCreate(char *host, int port)
{
	httpd	*new;
	int	sock,
		opt;
...
int httpdSetErrorFunction(httpd *server, int error, void (*function)() function)
{
